...
function Dashbord() {
  ...
  return (
    <div className="wrapper-full w-screen bg-lightColor-300 dark:bg-grayshade-300 flex justify-between">
      <aside className="w-3/12 lg:p-20 bg-lightColor-100 dark:bg-grayshade-500 rounded-xl">
